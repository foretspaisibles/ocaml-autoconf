...
C</usr/share/ocaml-autoconf/ocaml.m4> file to the autoconf macros
directory in your project.  Normally this is the C<m4/> directory in
your project, but the directory can be changed using the
C<AC_CONFIG_MACRO_DIR(DIR)> directive.  If you have just created the
C<m4> directory, then you may also need to do:
...
/usr/share/ocaml-autoconf/ocaml.m4
